...
$this->title = 'Quản lý';
$this->params['breadcrumbs'][] = ['label' => 'Đại lý', 'url' => ['index']];
...
$filter_city = City::getAllCityDDL();
?>
<div class="white_bg">
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute'=>'city_id',
                        'filter'=>$filter_city,
                        'value'=>function ($data) use ($filter_city) {
                            return Html::dropDownList('city_id_ddl', $data->city_id, $filter_city, [
                    ...
                    [
                        ...
                        'filter'=>[0 => 'Không', 1 => 'Có'],
                        'value'=>function ($data) {
                            return Html::checkbox('home_chb[]', $data->home?1:0, ["data-attr" => "home", "class" => "cajax"]);
                        },
                        'format' => 'raw',
