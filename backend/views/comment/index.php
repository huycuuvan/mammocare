...
$this->title = 'Quản lý';
$this->params['breadcrumbs'][] = ['label' => 'Khách hàng nói', 'url' => ['index']];
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value'=>function ($data) {
                            if ($data->thumb)
                                return Html::img(Yii::$app->urlManagerFrontend->baseUrl.'/'.$data->thumb, ['title' => $data->name, 'alt' => $data->name, 'width' => 40]);
