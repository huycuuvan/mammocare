            ...
            <div class="white_bg">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-4 ">
                            <?= $form->field($model, 'parent')->dropDownList(CatDoctor::getParentDDL(), [
                    ...
                    <div class="row">
                        <div class="col-12 d-none"><?= $form->field($model, 'brief')->textInput(['maxlength' => true]); ?></div>
                       <div class="col-12 d-none">
                           <?= $form->field($model, 'description2', ['enableClientValidation' => false])->textArea(['maxlength' => true,'class' => 'ckeditor']); ?>
                        </div>

                        <div class="col-12 d-none">
                           <?= $form->field($model, 'description', ['enableClientValidation' => false])->textArea(['maxlength' => true,'class' => 'ckeditor']); ?>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="format_seo">
                              ...
                              if ($model->isNewRecord) {
                                ...
                                $base_url = $_SERVER['SERVER_NAME'].Yii::$app->urlManagerFrontend->createUrl(['site/list-product', 'id' => $model->id, 'name' => $model->url,'page'=>1]);
                                  ?>
        ...
        <div class="col-md-4">
            ...
            <div class="white_bg vina-right" style="padding-bottom: 0;">
                <div class="container-fluid">
                    ...
                    <!-- Begin tải ảnh đại diện -->
                     <strong class="title_box">Ảnh banner</strong>
                     <div class="row">
                         <div class="col-12">
                            <div class="temp_img">
                               <img src="<?=(($model->path2) ? (Yii::$app->urlManagerFrontend->baseUrl.'/'.$model->path2) : 'images/choose_img.jpg'); ?>" data-noimage="images/choose_img.jpg" alt="<?=$model->name; ?>" />
                               <?= $form->field($model, 'file2')->fileInput()->label(false); ?>
                               <?= $form->field($model, 'path2')->hiddenInput()->label(false); ?>
                               <a href="#">Xóa</a>
                            </div>
                         </div>
                     </div>
