...
if (!empty($conf->editorbuilder)) {
    $this->params['vn-navbar'][] = Html::a('<i class="far fa-edit"></i> ' . ($edit_mode ? 'Soạn cơ bản' : 'Soạn nâng cao'), ['update', 'id' => $model->id, 'change' => 1, 'editor' => $edit_mode ? 0 : 1], ['class' => 'btn btn-success rounded-sm switch_form']);
}
