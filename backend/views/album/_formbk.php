        ...
        <div class="col-md-8">
            ...
            <div class="white_bg">
                <div class="container-fluid">
                    ...
                    <p class="text-right">
                        <!-- Begin nút thêm ảnh -->
                        <a href="#" class="fileinput-button" style="display: inline-block; line-height: 20px;">+ Thêm ảnh mới
                        ...
                        if (!empty($model->imgs)) {
                            ...
                            foreach ($imgs as $row) {
                                ...
                                <li data-id="<?=$row->id; ?>">
                                    ...
                                    <a class="video_tag" href="#" title="Mã Youtube"><i class="fab fa-youtube-square"></i></a>
                                </li>
                                <?php
                            }
                        }
