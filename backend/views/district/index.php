...
$filter_Province = Province::getAllProvinceDDL();
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'value'=>function ($data) use ($filter_Province) {
                        return Html::dropDownList('province_id_ddl', $data->province_id, $filter_Province, [
                            "prompt" => "Vui lòng chọn...",
                            "data-attr" => "province_id",
                            "class" => "cajax"
                        ]);
                    },
                    'format' => 'raw',
