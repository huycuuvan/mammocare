            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute'=>'has_image',
                        'value'=>function ($data) {
                            return Html::checkbox('has_image[]', ($data->has_image)?1:0, ["data-attr" => "has_image", "class" => "cajax"]);
                        },
                        'format' => 'raw',
                        'contentOptions' => ['style' => 'width:80px; text-align: center'],
                    ],
                    [
                        ...
                        'contentOptions' => ['style' => 'width:100px; text-align: center; font-size: 14px; line-height: 18px;'],
                        'buttons' => [
                            'propertyvalue' => function ($action, $model, $key ) {
                                return Html::a('<i class="fas fa-cogs"></i>', Url::to(['property-value/index','property'=>$model->id]),['target'=>'_blank']);
                            }
                        ]
                    ],
                    [
