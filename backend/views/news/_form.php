        ...
        <div class="col-lg-8">
            ...
            <div class="white_bg">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <?= $form->field($model, 'brief')->textArea(['rows' => 5, 'id' => 'ckbasic']); ?>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <?= $form->field($model, 'cat_id')->dropDownList(CatNews::getAllCatNewsDDL(), ['prompt' => 'Vui lòng chọn...']); ?>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="format_seo">
                              ...
                              if ($model->isNewRecord) {
                                ...
                                $base_url = $_SERVER['SERVER_NAME'].Yii::$app->urlManagerFrontend->createUrl(['site/news', 'id' => $model->id, 'name' => $model->url]);
                                  ?>
        ...
        <div class="col-lg-4">
            ...
            <div class="white_bg vina-right" style="padding-bottom: 0;">
                <div class="container-fluid">
                    ...
                    <!-- Begin tải ảnh đại diện -->
                    <strong class="title_box d-none">Tags tìm kiếm</strong>
