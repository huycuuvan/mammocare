...
<div class="login_admin">
    <div class="wrapper-login">
        ...
        <div class="site-login">
            <p class="text-center">
                <a href="http://vinaweb.vn" target="_blank"><img src="logo.png" alt="vinaweb"></a>
            </p>
            <div class="row">
                <div class="col-12">
                    <?php
                    if (Yii::$app->session->hasFlash('success')) {
                        ...
                        $form = ActiveForm::begin(['id' => 'reset-password-form']); ?>
                            ...
                            <p class="text-center"><?= Html::submitButton('Lưu mật khẩu mới', ['class' => 'btn btn-primary', 'name' => 'login-button']); ?></p>
                        <?php ActiveForm::end();
                    }
                    ?>
