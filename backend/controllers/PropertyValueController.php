...
use backend\models\search\PropertyValueSearch;
 ...
 */
class PropertyValueController extends InitController
{
    /**
     * {@inheritdoc}
     */
...
//    }
     ...
     * @return mixed
     */
    public function actionIndex($property)
    {
        $searchModel = new PropertyValueSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams,$property);
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['index', 'property' => $model->property_id]);
        }
