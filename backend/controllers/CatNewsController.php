...
use backend\models\search\CatNewsSearch;
 ...
 */
class CatNewsController extends InitController
{
    /**
    ...
    public function actionCreate()
    {
        ...
        if (in_array(Yii::$app->request->get('position'), array_keys(CatNews::getPosition()))) {
