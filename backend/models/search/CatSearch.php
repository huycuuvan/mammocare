...
/**
 * CatSearch represents the model behind the search form of `backend\models\Cat`.
 */
class CatSearch extends Cat
{
    ...
    {
        $query = Cat::find()->select(['*', 'REPLACE(path, "/'.parent::tableName().'/", "/'.parent::tableName().'/thumb/") AS thumb']);
