...
class UploadHandler
{
            ...
            'image_versions' => array(
		        ...
		        */
                'thumbnail' => array(
                    ...
                    'max_width' => $conf->product_thumb_width, // either specify width, or set to 0. Then width is automatically adjusted - keeping aspect ratio to a specified max_height.
                    'max_height' => $conf->product_thumb_height // either specify height, or set to 0. Then height is automatically adjusted - keeping aspect ratio to a specified max_width.
                )
            ),
    ...
    protected function set_additional_file_properties($file) {
        ...
        //====================MR.HA CUSTOMIZE======================
        //setup pid property for file
        $file->pid = $this->options["pid"];
    ...
    protected function handle_form_data($file, $index) {
        ...
        //====================MR.HA CUSTOMIZE======================
        //setup value to pid option
        $this->options["pid"] = $_POST['pid'];
    }
    ...
    protected function basename($filepath, $suffix = null) {
        ...
        $img_name = substr(basename('X'.$splited[count($splited)-1], $suffix), 1);
        return rand(3, 9999).MyExt::removeSign($img_name);
    }
}
