...
//            $this->cart[$str_item] += $num;
    ...
    public function save()
    {
        ...
        Yii::$app->session->set('EmailCart', serialize($data));
    }
    ...
    {
        if (Yii::$app->session->get('EmailCart')) {
            $data=unserialize(Yii::$app->session->get('EmailCart'));
