...
class HostingCart extends Model
{
...
//            $this->cart[$str_item] += $num;
    ...
    public function save()
    {
        ...
        Yii::$app->session->set('HostingCart', serialize($data));
    }
    ...
    {
        if (Yii::$app->session->get('HostingCart')) {
            $data=unserialize(Yii::$app->session->get('HostingCart'));
